...
search_keywords = ['climb', 'summit', 'banana', 'business', 'race']
...
# Shape (# search keywords, # of documents)
sort_ind = np.linalg.norm(max_vals, axis=0).argsort()  # In increasing order
print("In order of decreasing prevalence of the keyword")
print(list_of_text_files[np.flip(sort_ind)])